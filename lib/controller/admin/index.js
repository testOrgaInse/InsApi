...
import StructuresTeamsAccounts from "./structuresTeamsAccounts";
...
app.use(mount("/account_structures_teams", StructuresTeamsAccounts)); // Comptes structures et teams
...
app.use(mount("/structures", structuresRoutes)); // Structures
