...
import AccountsFedeInserm from "../../models/AccountsFedeInserm";
import AccountsStructuresTeams from "../../models/AccountsStructuresTeams";
...
app.use(mount("/accounts_fede_inserm", postgresCrud(AccountsFedeInserm))); // Comptes fédéinserm
app.use(
  mount("/account_structures_teams", postgresCrud(AccountsStructuresTeams))
