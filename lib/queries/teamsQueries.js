...
const selectNbAccountStructures = `SELECT COUNT(id)
...
const selectNbAccountTeams = `SELECT COUNT(id)
FROM account_structures_teams
WHERE account_structures_teams.structure_code = structures.id 
AND account_structures_teams.type_of_code = 'Equipe'`;

const selectNbAccountIndividual = `SELECT COUNT(id) 
...
teamsQueries.selectOne
  .table("teams INNER JOIN structures ON teams.structure_code = structures.id")
  .returnFields(fields);

teamsQueries.updateOne.updatableFields([
  "structure_code",
  "team_number",
  "name",
  "principal_lastname",
...
teamsQueries.selectPage
  .table("teams LEFT JOIN structures ON teams.structure_code = structures.id")
