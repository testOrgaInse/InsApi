...
const selectByNames = selectByOrderedFieldValuesQuery("community", "name", [
  "id",
  "name",
  "gate",
  "user_id",
...
const selectByIds = selectByOrderedFieldValuesQuery("community", "id", [
  "id",
  "name",
  "gate",
  "user_id",
...
const selectByDatabaseId = selectPageQuery(
  "community JOIN database_community ON (community.id = database_community.community_id)",
  ["database_id"],
  [
    "id",
    "database_id",
...
const selectByRevueId = selectPageQuery(
  "community JOIN revue_community ON (community.id = revue_community.community_id)",
  ["revue_id"],
  ["id", "revue_id", "name", "gate", "user_id", "password", "profile", "ebsco"]
);
