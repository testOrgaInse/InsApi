...
structuresTeamsAccountsQueries.selectPage
  .table(
    `account_structures_teams JOIN structures ON account_structures_teams.structure_code = structures.id
     JOIN teams ON account_structures_teams.team_number = teams.id`
  )
  .returnFields(fields);
