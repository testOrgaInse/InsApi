...
function Community(client) {
  ...
  const selectByDatabaseId = function*(databaseId) {
    return yield communityClient.selectByDatabaseId(null, null, {
      database_id: databaseId
    });
  };

  const selectByRevueId = function*(revueId) {
    return yield communityClient.selectByRevueId(null, null, {
      revue_id: revueId
    });
  };
