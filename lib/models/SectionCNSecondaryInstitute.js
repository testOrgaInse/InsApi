...
function SectionCNSecondaryInstitute(client) {
  const sectionCNSecondaryInstituteClient = client.link(
    SectionCNSecondaryInstitute.queries
  );

  const assignSecondaryInstituteToSectionCN = function*(units, sectionCNId) {
    return yield sectionCNSecondaryInstituteClient.batchUpsert(
  ...
  const unassignSecondaryInstituteFromSectionCN = function*(
    instituteIds,
    sectionCNId
  ) {
    return yield sectionCNSecondaryInstituteClient.batchDelete(
