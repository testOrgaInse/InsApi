...
describe("model StructuresTeamsAccounts", function() {
  ...
  describe("selectOne", function() {
    it("should return one user by id", function*() {
      ...
      const user = yield fixtureLoader.createStructureTeamAccount({
        login: "jane_doe",
        password: "secret",
        type_of_code: "proxy",
        structure_type: "CIC",
      ...
      assert.deepEqual(
        yield structuresTeamsAccountsQueries.selectOne({ id: user.id }),
        {
          id: user.id,
          login: "jane_doe",
          password: "secret",
          ...
          city: structure.city,
          site: structure.site,
          cnrs_mixity: structure.cnrs_mixity,
          mixt_university: structure.mixt_university,
          other_mixity: structure.other_mixity,
          name: team.name,
          principal_email: team.principal_email,
          principal_firstname: team.principal_firstname,
          principal_lastname: team.principal_lastname,
          principal_it: structure.principal_it,
          regional_delegation: structure.regional_delegation,
          specialized_commission: structure.specialized_commission
        }
      );
    });
